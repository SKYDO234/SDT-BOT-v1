...
# ---------------------------------------------------------
# TAILSCALE AUTOMATION PIPELINE (FIXED SOCKET ISSUE)
# ---------------------------------------------------------
def _setup_tailscale_sync(container_id: str, auth_key: str) -> str:
    ...
    up_cmd = f"tailscale --socket=/var/run/tailscale/tailscaled.sock up --authkey={auth_key} --hostname={container.name}"
